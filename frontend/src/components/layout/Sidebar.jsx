  ...
  return (
    <aside className="sidebar-wide">
      ...
      <div className="sidebar-wide-bottom">
        ...
        {/* Seção admin — só aparece para admin */}
        {user?.role === 'admin' && (
          <>
            <div className="sidebar-wide-section-label" style={{ marginBottom: 2 }}>
            ...
            >
              ...
              <span className="sidebar-wide-label">Gestão do Sistema</span>
            </button>

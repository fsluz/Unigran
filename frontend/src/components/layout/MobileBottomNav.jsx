...
const QUICK = [
  ...
  { id: 'admin', label: 'Admin', anyPerm: ['system:manage', 'audit:read', 'users:platform_manage', 'reports:read'] },
];
...
function NavIcon({ name }) {
  ...
  if (name === 'rai') return <img className="mobile-rai-icon" src={raiMascot} alt="" aria-hidden="true" />;
